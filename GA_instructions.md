...
Due: Tuesday, February 20th at 9 AM ET
...
## Requirements
This project will be hosted on **GitHub**, not GA's GitHub Enterprise, so it will be a public project for your portfolio and will add to your github activity.  For the purposes of a DSB project, you must meet a few technical requirements. They are:
1)  A `README.md` file in your project repo. Note that `README` files are automatically rendered by GitHub when you view a repo. Your README should contain:
    ...
    - A table of contents, which should indicate which notebook or scripts a stakeholder should start with
    - A section on or link to an **executive summary**.
...
3) Collaborate and document everyone's contributions:
    - There should be **_one_** main repository, owned and maintained by one team member. All team members should have their own forks or branches, using merge requests or pull requests to contribute.
    - Every team members contributions should be made clear by using one or more practices:
      - Documenting division of labor & responsibilities within your README
      - Work in individual workbooks, with a clear explanation of how work was handed over between team members.
      - Combine the code into common notebooks, with sections and code blocks accredited to the appropriate team members.
    - REMEMBER: identify & stick with clear naming conventions for any files and assets created.

4) Bear in mind that the value you provide may come from data ingestion, data cleaning, EDA, and/ or a dashboard, etc. While a model may not be immediately apparent, be creative. *Without us telling you exactly what model to build, how could you build a model to increase performance or generate better insights when answering the problem you are facing?*
...
- Group 1: Aaran, Ben W., Steve
- Group 2: Danny C., Heather, Kelly
- Group 3: Ben M., Daniel K., Dominic
...
- *Keep presentation timing to about 15 minutes.* Your presentation should be long enough to cover all relevant aspects of the problem, but not so long that it obscures the takeaways of the presentation.  
- Everyone in the group must speak.
- Your presentation must include slides. (Google Slides, PowerPoint, Keynote, etc.)
- Use visuals that are appropriately scaled and interpretable.
- Use and explain relevant metrics in model evaluation. Translate these findings for nontechnical audience members.
...
Note: projects will be graded as a group, though we will take into account individual contributions.  
